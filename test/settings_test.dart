...
void main() {
  group('SettingsGeneralProvider Tests', () {
    ...
    test('Subscription Entitlement Logic', () async {
      await provider.refreshData();
      // No subscription map -> free.
      expect(provider.subscription.effectiveTier, SubscriptionTier.free);
      ...
      await provider.refreshData();
      expect(provider.subscription.effectiveTier, SubscriptionTier.plus);
      ...
      await provider.refreshData();
      expect(provider.subscription.effectiveTier, SubscriptionTier.pro);
    });
