...
class _AudioPlayerWidgetState extends State<AudioPlayerWidget> {
      ...
      builder: (ctx) {
        return Container(
          ...
          child: Column(
            ...
            children: [
              ListTile(
                leading: Icon(Icons.share_rounded, color: AppColors.primaryColor.inverted),
                title: Text(l10n.download, style: TextStyle(color: AppColors.primaryColor.inverted, fontWeight: FontWeight.bold)),
                onTap: () {
                  Navigator.pop(ctx);
                  Share.shareXFiles([XFile(widget.audioPath)]);
                },
              ),
            ],
          ),
  ...
  Widget build(BuildContext context) {
    ...
    final double playerWidth = isTablet ? widget.screenWidth * 0.5 : widget.screenWidth * 0.7;
    final double padding = isTablet ? widget.screenWidth * 0.015 : 14.0;
    final l10n = AppLocalizations.of(context)!;
    final String extension = widget.audioPath.split('/').last.split('.').last.toUpperCase();
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: widget.isUser ? AppColors.secondaryColor.withValues(alpha: 0.5) : AppColors.primaryColor,
          borderRadius: BorderRadius.circular(20),
          border: Border.all(color: AppColors.border),
        ),
        child: Column(
                    ...
                    children: [
                      SliderTheme(
                        data: SliderTheme.of(context).copyWith(
                          ...
                          activeTrackColor: AppColors.primaryColor.inverted.withValues(alpha: 0.8),
