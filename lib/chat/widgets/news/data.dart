// lib/chat/screen/unselected/widgets/news/data.dart
...
class NewsArticle {
  ...
  bool get isValid {
    final hasEnglishTitle = title['en'] != null && title['en']!.trim().isNotEmpty;
    final hasEnglishSummary = summary['en'] != null && summary['en']!.trim().isNotEmpty;
  ...
  factory NewsArticle.fromJson(Map<String, dynamic> json) {
    ...
    return NewsArticle(
      ...
      content: contentMap,
      link: link,
      coverImagePaths: json['cover'] != null ? Map<String, String>.from(json['cover'] as Map) : null,
