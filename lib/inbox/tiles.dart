...
class ConversationTile extends StatefulWidget {
  ...
  @override
  ConversationTileState createState() => ConversationTileState();
}
...
class ConversationTileState extends State<ConversationTile>
  ...
  static ConversationTileState? _currentlyOpenTileState;
    ...
    for (int i = 0; i < n; i++) {
      ...
      spans.add(TextSpan(
        ...
        style: GoogleFonts.poppins(
          ...
          fontWeight: FontWeight.w500,
          height: lineHeight,
          color: (AppColors.primaryColor.inverted).withValues(alpha: opacity),
        ),
      ));
    }
