...
class AppLocalizationsSv extends AppLocalizations {
  ...
  @override
  String get offlineUse => 'Använd utan Internet';

  @override
  String get archivedConversations => 'Arkiverade konversationer';

  @override
  String get noArchivedConversations => 'Inga arkiverade konversationer';

  @override
  String get unarchive => 'Avarkivera';
  ...
  @override
  String get premiumChatGateTitle => 'Lås upp fler möjligheter';

  @override
  String get premiumChatGateDescription =>
      'Uppgradera till Cortex Premium för att få tillgång till den här kraftfulla AI-modellen och mer.';

  @override
  String get premiumChatGateCta => 'Skaffa Premium';

  @override
  String get testPurchaseTitle => 'Testköp';
  ...
  String testPurchaseNotice(String plan, String duration) {
    return 'Simulerad betalning för testning — ingen riktig avgift debiteras. Detta ger $plan-åtkomst i $duration.';
  }

  @override
  String get testPurchaseConfirm => 'Slutför testköp';
  ...
  String get testModeInfo =>
      'Testläge: köp är simulerade och beviljar kortvariga testrättigheter — verklig fakturering förekommer aldrig.';

  @override
  String get testSubscriptionManage => 'Avsluta testprenumeration';

  @override
  String get testPurchaseSuccess => 'Testprenumerationen är nu aktiv.';

  @override
  String get testPurchaseRevoked => 'Testprenumerationen avslutad.';
  ...
  String creditWarningFreeDecliningMessage(String renewalTime) {
    return 'Dina gratiskrediter för idag har tagit slut, svaren kan bli enklare. De förnyas om $renewalTime. Uppgradera för bästa intelligens.';
  }

  @override
  String creditWarningPaidUpgradeMessage(String renewalTime) {
    return 'Dina krediter börjar ta slut, svaren kan bli enklare. De förnyas om $renewalTime. Uppgradera ditt abonnemang för mer användning.';
  }

  @override
  String creditWarningUltraMessage(String renewalTime) {
    return 'Du närmar dig din användningsgräns, svaren kan bli enklare. Den förnyas om $renewalTime.';
  }

  @override
  String creditWarningExhaustedMessage(String renewalTime) {
    return 'Du har använt alla dina krediter för idag. De förnyas om $renewalTime. Uppgradera för att fortsätta utan gränser.';
  }

  @override
  String creditWarningUltraExhaustedMessage(String renewalTime) {
    return 'Du har nått din användningsgräns för idag. Den förnyas om $renewalTime.';
  }
