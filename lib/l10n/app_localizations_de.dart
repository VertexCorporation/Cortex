...
class AppLocalizationsDe extends AppLocalizations {
  ...
  @override
  String get benefitMoreVoiceChat => 'Mehr Sprachchats';
  ...
  String confirmRemoveModel(Object model) {
    return 'Möchten Sie das Modell $model wirklich von Ihrem Gerät entfernen? Dadurch werden auch alle vorherigen Konversationen mit diesem Modell gelöscht.';
  }
  ...
  String get falErrorImageRequired =>
      'Diese KI benötigt ein Referenzbild. Bitte fügen Sie ein Bild an und versuchen Sie es erneut.';

  @override
  String get falErrorAudioRequired =>
      'Für dieses Modell wird eine Referenz-Audiodatei benötigt. Bitte fügen Sie eine Audiodatei bei und versuchen Sie es erneut.';

  @override
  String get falErrorVideoRequired =>
      'Für dieses Modell wird ein Referenzvideo benötigt. Bitte fügen Sie ein Video bei und versuchen Sie es erneut.';
  ...
  String falErrorGenericStatus(int statusCode) {
    return 'Der Generierungsdienst hat einen Fehler zurückgegeben (Status $statusCode).';
  }
  ...
  @override
  String get shortcuts => 'Abkürzungen';
  ...
  @override
  String get featureReasoning => 'Tiefgründiges Denken';

  @override
  String get featureReasoningDescription =>
      'Im Modus „Tiefes Denken“ durchdenkt die KI Aufgaben intern, um sie bestmöglich zu erledigen.';
  ...
  String get toolReadDocumentIndexParam =>
      'Der Index des zu lesenden Dokumentenanhangs (beginnend bei 0). Normalerweise 0 für das erste Dokument.';

  @override
  String get toolStockDescription =>
      'Erhalten Sie aktuelle Preise und historische Daten für Aktien (z. B. AAPL, THYAO.IS) und Kryptowährungen (z. B. BTC-USD).';

  @override
  String get toolStockSymbolParam =>
      'Das Börsenkürzel (z. B. AAPL, THYAO.IS, BTC-USD).';

  @override
  String get toolWeatherDescription =>
      'Aktuelles Wetter für eine bestimmte Stadt abrufen.';
  ...
  String get toolPythonDescription =>
      'Führe Python-Code in einer sicheren Sandbox aus.';

  @override
  String get toolPythonCodeParam => 'Der auszuführende Python-Code.';
  ...
  String get toolChartLabelsParam =>
      'Beschriftungen für Diagrammachsen oder -segmente.';

  @override
  String get toolChartDataParam => 'Numerische Datenwerte für das Diagramm.';

  @override
  String get toolChartLabelParam =>
      'Datensatzbezeichnung für die Diagrammlegende.';
  ...
  @override
  String get offlineUse => 'Ohne Internet nutzen';

  @override
  String get archivedConversations => 'Archivierte Gespräche';

  @override
  String get noArchivedConversations => 'Keine archivierten Gespräche';
  ...
  String get personalizationDescription =>
      'Personalisieren Sie Ihren Assistenten, damit er besser zu Ihren Bedürfnissen passt. Passen Sie seine Antworten, sein Verhalten und seinen Tonfall Ihren individuellen Vorlieben an.';
  ...
  String get noArtDescription =>
      'Noch keine Werke vorhanden; füllen Sie die Galerie mit Bildern, Videos, Audio und Inhalten aller Art!';

  @override
  String get videoPremiumWarning =>
      'Sie benötigen ein Ultra-Abonnement, um Videos zu erstellen. Jetzt upgraden und den Flow erleben!';

  @override
  String get fallbackInfoPanelText =>
      'Aufgrund von Verbesserungen an unserem Server wurde die Antwort vom dynamischen Chat von Cortex und nicht von der von Ihnen ausgewählten KI generiert. Vielen Dank für Ihr Verständnis, bis die Arbeiten abgeschlossen sind!';

  @override
  String get falOfflineMessage =>
      'Aufgrund von Verbesserungen an unserem Server ist diese Funktion derzeit nicht verfügbar. Wir danken Ihnen für Ihr Verständnis, bis die Arbeiten abgeschlossen sind!';

  @override
  String get errorInsufficientStorage =>
      'Nicht genügend Speicherplatz zum Herunterladen dieses Modells.';

  @override
  String get backgroundChatNotificationTitle => 'Zurück zum Chat!';
  ...
  @override
  String get premiumChatGateTitle => 'Mehr Möglichkeiten freischalten';

  @override
  String get premiumChatGateDescription =>
      'Wechsle zu Cortex Premium, um auf dieses leistungsstarke KI-Modell und mehr zuzugreifen.';

  @override
  String get premiumChatGateCta => 'Premium abonnieren';

  @override
  String get testPurchaseTitle => 'Testkauf';
  ...
  String testPurchaseNotice(String plan, String duration) {
    return 'Simulierte Zahlung zu Testzwecken — es wird keine echte Abbuchung vorgenommen. Du erhältst $plan für $duration.';
  }

  @override
  String get testPurchaseConfirm => 'Testkauf abschließen';
  ...
  String get testModeInfo =>
      'Testmodus: Käufe sind simuliert und gewähren kurzzeitige Test-Berechtigungen — echte Abbuchungen erfolgen nie.';

  @override
  String get testSubscriptionManage => 'Testabo kündigen';

  @override
  String get testPurchaseSuccess => 'Das Testabo ist jetzt aktiv.';

  @override
  String get testPurchaseRevoked => 'Das Testabo wurde gekündigt.';
