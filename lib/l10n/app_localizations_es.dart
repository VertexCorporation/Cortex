...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get benefitMoreVoiceChat => 'Más chat de voz';
  ...
  @override
  String get notificationNewYearTitle => '¡Feliz año nuevo! ğŸ‰';
  ...
  String get notificationTrollAnimeBody =>
      'Una chica anime acaba de llamar y dijo que te extraña; Probablemente deberías venir y charlar con ella. ğŸ˜‰';
  ...
  String get notificationPirateBody =>
      'El mar está en calma y el viento sopla a tu espalda. Hay nuevas islas (modelos ğŸ˜‰) por descubrir en el océano de Cortex. ¡Reúne a tu tripulación y zarpa!';
  ...
  @override
  String get offlineUse => 'Usar sin Internet';

  @override
  String get archivedConversations => 'Conversaciones archivadas';

  @override
  String get noArchivedConversations => 'No hay conversaciones archivadas';
  ...
  @override
  String get premiumChatGateTitle => 'Desbloquea más posibilidades';

  @override
  String get premiumChatGateDescription =>
      'Pásate a Cortex Premium para acceder a este potente modelo de IA y mucho más.';

  @override
  String get premiumChatGateCta => 'Únete a Premium';

  @override
  String get testPurchaseTitle => 'Compra de prueba';
  ...
  String testPurchaseNotice(String plan, String duration) {
    return 'Pago simulado para pruebas — no se realizará ningún cargo real. Esto otorga acceso a $plan durante $duration.';
  }

  @override
  String get testPurchaseConfirm => 'Completar compra de prueba';
  ...
  String get testModeInfo =>
      'Modo de prueba: las compras son simuladas y otorgan derechos de prueba de corta duración — nunca implican facturación real.';

  @override
  String get testSubscriptionManage => 'Cancelar suscripción de prueba';

  @override
  String get testPurchaseSuccess => 'La suscripción de prueba ya está activa.';

  @override
  String get testPurchaseRevoked => 'Suscripción de prueba cancelada.';

  @override
  String testPurchaseError(String message) {
    return 'La compra de prueba falló: $message';
  }

  @override
  String get generationImageLabel => 'Generando Imagen';

  @override
  String get generationVideoLabel => 'Generando Vídeo';

  @override
  String get generationAudioLabel => 'Generando Audio';

  @override
  String get generationDocumentLabel => 'Generando Documento';

  @override
  String creditWarningFreeDecliningMessage(String renewalTime) {
    return 'Tus créditos gratuitos de hoy se han agotado, las respuestas pueden ser más sencillas. Se renuevan en $renewalTime. Hazte premium para mantener la mejor inteligencia.';
  }

  @override
  String creditWarningPaidUpgradeMessage(String renewalTime) {
    return 'Tus créditos están bajando, las respuestas pueden ser más sencillas. Se renuevan en $renewalTime. Mejora tu plan para tener más uso.';
  }

  @override
  String creditWarningUltraMessage(String renewalTime) {
    return 'Te estás acercando a tu límite de uso, las respuestas pueden ser más sencillas. Se renueva en $renewalTime.';
  }

  @override
  String creditWarningExhaustedMessage(String renewalTime) {
    return 'Has usado todos tus créditos de hoy. Se renuevan en $renewalTime. Hazte premium para seguir sin límites.';
  }

  @override
  String creditWarningUltraExhaustedMessage(String renewalTime) {
    return 'Has alcanzado tu límite de uso de hoy. Se renueva en $renewalTime.';
  }
