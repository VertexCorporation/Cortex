...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get messageHintShort => 'Demandez';
  ...
  @override
  String get benefitPremiumModels => 'Sélection d\'IA exclusive';
  ...
  @override
  String get notificationNewYearTitle => 'Bonne année! ğŸ‰';
  ...
  String get notificationTrollAnimeBody =>
      'Une fille d\'anime vient d\'appeler et dit que tu lui manques ; tu devrais probablement venir lui parler. Ÿ˜‰';
  ...
  String get notificationPirateBody =>
      'La mer est calme et le vent est dans votre dos. Il y a de nouvelles îles (modèles ğŸ˜‰) à découvrir dans l\'océan de Cortex. Rassemblez votre équipage et embarquez !';
  ...
  @override
  String get offlineUse => 'Utiliser sans Internet';

  @override
  String get archivedConversations => 'Conversations archivées';
  ...
  @override
  String get premiumChatGateTitle => 'Débloquez plus de possibilités';

  @override
  String get premiumChatGateDescription =>
      'Passez à Cortex Premium pour accéder à ce puissant modèle d’IA et à bien plus encore.';

  @override
  String get premiumChatGateCta => 'Rejoindre Premium';

  @override
  String get testPurchaseTitle => 'Achat test';
  ...
  String testPurchaseNotice(String plan, String duration) {
    return 'Paiement simulé à des fins de test — aucun débit réel ne sera effectué. Cela accorde l\'accès $plan pendant $duration.';
  }

  @override
  String get testPurchaseConfirm => 'Finaliser l\'achat test';
  ...
  String get testModeInfo =>
      'Mode test : les achats sont simulés et accordent des droits de test de courte durée — aucune facturation réelle n\'est impliquée.';

  @override
  String get testSubscriptionManage => 'Annuler l\'abonnement test';

  @override
  String get testPurchaseSuccess => 'L\'abonnement test est désormais actif.';

  @override
  String get testPurchaseRevoked => 'Abonnement test annulé.';

  @override
  String testPurchaseError(String message) {
    return 'Échec de l\'achat test : $message';
  }

  @override
  String get generationImageLabel => 'Création De L’Image';

  @override
  String get generationVideoLabel => 'Création De La Vidéo';

  @override
  String get generationAudioLabel => 'Création De L’Audio';

  @override
  String get generationDocumentLabel => 'Création Du Document';

  @override
  String creditWarningFreeDecliningMessage(String renewalTime) {
    return 'Vos crédits gratuits pour aujourd\'hui sont épuisés, les réponses peuvent être plus simples. Ils se renouvellent dans $renewalTime. Passez à un abonnement payant pour garder la meilleure intelligence.';
  }

  @override
  String creditWarningPaidUpgradeMessage(String renewalTime) {
    return 'Vos crédits diminuent, les réponses peuvent être plus simples. Ils se renouvellent dans $renewalTime. Améliorez votre abonnement pour plus d\'utilisation.';
  }

  @override
  String creditWarningUltraMessage(String renewalTime) {
    return 'Vous approchez de votre limite d\'utilisation, les réponses peuvent être plus simples. Elle se renouvelle dans $renewalTime.';
  }

  @override
  String creditWarningExhaustedMessage(String renewalTime) {
    return 'Vous avez utilisé tous vos crédits pour aujourd\'hui. Ils se renouvellent dans $renewalTime. Passez à un abonnement payant pour continuer sans limite.';
  }

  @override
  String creditWarningUltraExhaustedMessage(String renewalTime) {
    return 'Vous avez atteint votre limite d\'utilisation pour aujourd\'hui. Elle se renouvelle dans $renewalTime.';
  }
