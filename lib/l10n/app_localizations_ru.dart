...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get creditsInfoPanelBody =>
      'Кредиты используются для чата с онлайн-моделями. каждое сообщение влетает нам в копеечку и эти кредиты спасают нас от банкротства ну а теперь давайте объясним систему\n\n• Каждое сообщение бесплатной онлайн-модели стоит 10 кредитов.\n• Каждое сообщение премиальной онлайн-модели стоит 20 кредитов.\n• Добавление вложения добавляет еще 30 кредитов.\n• Пользователи бесплатного плана получают бонус в размере 200 кредитов, который сбрасывается ежедневно.';
  ...
  String get loginSubtitle =>
      'Войдите в свой аккаунт Vertex. Новые пользователи, регистрирующиеся через Google, соглашаются с нашими Условиями и Политикой конфиденциальности. Вы можете ознакомиться с ними на экране регистрации.';
