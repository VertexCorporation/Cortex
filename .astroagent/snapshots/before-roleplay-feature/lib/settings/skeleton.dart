...
class SkeletonLoader extends StatelessWidget {
  ...
  Widget _buildSkeletonSettingsItem(BuildContext context, {
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Row(
                children: [
                  _buildSkeletonContent(context, width: iconSize,
                      height: iconSize,
                      radius: iconSize / 2),
                  SizedBox(width: horizontalPadding),
                  _buildSkeletonContent(
                      context, width: screenWidth * textWidthRatio,
                      height: textHeight,
                      radius: 4),
                ],
              ),
              _buildSkeletonContent(
                  context, width: arrowSize, height: arrowSize, radius: 4),
            ],
          ),
        ),
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  _buildSkeletonContent(context, width: screenWidth * 0.5,
                      height: titleHeight * 1.2),
                  SizedBox(height: smallSpacing * 0.7),
                  _buildSkeletonContent(context, width: screenWidth * 0.52,
                      height: descriptionHeight * 1.4),
                  SizedBox(height: medSpacing * 0.4),
                  Row(
                    children: [
                      _buildSkeletonBadge(
                          context, screenWidth * 0.045, screenWidth * 0.12,
                          descriptionHeight * 0.9),
                      SizedBox(width: screenWidth * 0.02),
                      _buildSkeletonBadge(
                          context, screenWidth * 0.045, screenWidth * 0.1,
                          descriptionHeight * 0.9),
                    ],
                  ),
                ],
        ...
        _buildSkeletonContent(
            context, width: screenWidth * 0.2, height: titleHeight * 1.5),
        SizedBox(height: smallSpacing * 0.2),
        _buildSkeletonContent(
            context, width: screenWidth * 0.7, height: descriptionHeight),
        SizedBox(height: smallSpacing * 0.2),
        _buildSkeletonContent(
            context, width: screenWidth * 0.7, height: descriptionHeight),
        ...
        _buildSkeletonContent(
            context, width: screenWidth * 0.4, height: titleHeight * 1.5),
        ...
        _buildSkeletonContent(
            context, width: screenWidth * 0.32, height: titleHeight * 1.5),
        SizedBox(height: smallSpacing * 0.2),
        _buildSkeletonContent(
            context, width: screenWidth * 0.7, height: descriptionHeight),
        SizedBox(height: smallSpacing * 0.2),
