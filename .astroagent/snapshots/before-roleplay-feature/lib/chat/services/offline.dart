...
class OfflineService {
  ...
  Future<void> sendMessage(String text, String? photoPath, [ChatInputMode? activeMode]) async {
  ...
  Future<String> _buildFormattedPrompt({
    ...
    // Language instruction for offline models
    if (langCode != 'en') {
      systemPrompt += "\n\nYou must always respond in $langCode.";
    }
